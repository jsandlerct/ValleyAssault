...
`)}var cl=new W;function ll(e){G._getMatrix(cl,G.workingColorSpace,e);let t=`mat3( ${cl.elements.map(e=>e.toFixed(4))} )`;switch(G.getTransfer(e)){case qe:return[t,`LinearTransferOETF`];case Je:return[t,`sRGBTransferOETF`];default:return z(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function ul(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
void main() {
    ...
    `;let n=new Yu(t);n.position.set(0,10,2),e.group.add(n),e.label=n}function Jf(e){if(!e.label)return;let t=e.breached?0:e.hp/e.maxHp*100,n=e.label.element.querySelector(`.hp-fill-3d`),r=e.label.element.querySelector(`.hp-pct`);n.style.width=t+`%`,n.style.backgroundColor=e.breached?`#ffd700`:t>60?`#4caf50`:t>30?`#ff9800`:`#f44336`,r.textContent=e.breached?`BREACHED`:Math.ceil(t)+`%`}function Yf(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#92897C`,t.fillRect(0,0,256,256);let n=t.getImageData(0,0,256,256),i=n.data;for(let e=0;e<i.length;e+=4){let t=(Math.random()-.5)*38;i[e]=Math.max(0,Math.min(255,i[e]+t)),i[e+1]=Math.max(0,Math.min(255,i[e+1]+t)),i[e+2]=Math.max(0,Math.min(255,i[e+2]+t*.8))}t.putImageData(n,0,0),t.strokeStyle=`rgba(40,35,30,0.55)`,t.lineWidth=3;for(let e=0;e<=256/32;e++){let n=e*32,r=e%2*(64/2);t.beginPath(),t.moveTo(0,n),t.lineTo(256,n),t.stroke();for(let e=-1;e<=5;e++){let i=e*64+r;t.beginPath(),t.moveTo(i,n),t.lineTo(i,n+32),t.stroke()}}let a=new ua(e);return a.wrapS=a.wrapT=r,a.repeat.set(5,3),a}var Xf=new Oa({map:Yf(),roughness:.92,metalness:.02});function Zf(e){e.traverse(e=>{e.isMesh&&(e.material=Xf,e.castShadow=!0,e.receiveShadow=!0)})}function Qf(e,t,n=rd.SX,r=rd.SY,i=rd.SZ){let a=e.clone(t);a.scale.set(n,r,i),a.updateMatrixWorld(!0);let o=new nr;return a.traverse(e=>{if(e.isMesh&&e.geometry){e.geometry.computeBoundingBox();let t=e.geometry.boundingBox.clone().applyMatrix4(e.matrixWorld);o.union(t)}}),o.isEmpty()||(a.position.y=-o.min.y),Zf(a),a}function $f(e,t,n=rd.SX){let r=e.clone(t);return r.updateMatrixWorld(!0),new nr().setFromObject(r).getSize(new U).x*n||2}var ep=new Oa({color:8024160,roughness:.95,metalness:0});function tp(e){let t=[];for(let n=0;n<22;n++){let n=.25+Math.random()*.7,r=.15+Math.random()*.5,i=new si(new ma(n,r,.2+Math.random()*.6),ep);i.position.set((Math.random()-.5)*7,r/2+Math.random()*.2,Math.random()*3.5-.5),i.rotation.set((Math.random()-.5)*1,Math.random()*Math.PI*2,(Math.random()-.5)*1),i.castShadow=!0,e.add(i),t.push(i)}return t}var np=class{#e=Z.SECTION_HP;maxHp=Z.SECTION_HP;labelDirty=!0;breached=!1;engagedSquads=[];label=null;group=null;closedGate=null;openGate=null;onBreach=null;#t=[];get hp(){return this.#e}set hp(e){this.#e=e,this.labelDirty=!0}constructor(e){this.id=e,this.group=new Mn,hd.add(this.group)}breach(){if(!this.breached){this.breached=!0,this.hp=0,this.closedGate&&(this.closedGate.visible=!1),this.openGate&&(this.openGate.visible=!1),this.#t=tp(this.group),this.label&&this.label.element.classList.add(`breached`);for(let e of this.engagedSquads)e.order===`engaged`&&(e.order=`idle`);this.onBreach?.(),$.checkBreach()}}reset(e){for(let e of this.#t)this.group.remove(e);this.#t=[],this.closedGate&&(this.closedGate.visible=!0),this.openGate&&(this.openGate.visible=!1),this.label&&this.label.element.classList.remove(`breached`),this.breached=!1,this.engagedSquads=[],this.hp=e,this.labelDirty=!0}};function rp(e,t){let n=$f(e,X.WALL,rd.SX),r=$f(e,X.TOWER,rd.SX),i=$f(e,X.DOOR_CLOSED,rd.SX),a=10-r-i/2,o=Math.max(1,Math.round(a/n)),s=o>0?a/o:n;for(let n of t){let t=n.group;t.position.set(Z.SECTION_X[n.id],0,Z.WALL_Z);let c=Qf(e,X.TOWER);c.position.x=-10+r/2,t.add(c);let l=Qf(e,X.TOWER);if(l.position.x=10-r/2,l.rotation.y=Math.PI,t.add(l),o>0&&a>0){let n=-10+r;for(let r=0;r<o;r++){let i=Qf(e,X.WALL);i.position.x=n+(r+.5)*s,t.add(i)}let i=10-r;for(let n=0;n<o;n++){let r=Qf(e,X.WALL);r.position.x=i-(n+.5)*s,t.add(r)}}let u=rd.SY*.526+.5,d=10-i/2,f=(10+i/2)/2,p=new ma(d,u,.3),m=new si(p,Xf);m.position.set(-f,u/2,-.15),m.receiveShadow=!0,t.add(m);let h=new si(p,Xf);h.position.set(f,u/2,-.15),h.receiveShadow=!0,t.add(h);let g=Qf(e,X.DOOR_CLOSED);g.position.x=0,g.visible=!0,t.add(g),n.closedGate=g;let _=Qf(e,X.DOOR_OPEN);_.position.x=0,_.visible=!1,t.add(_),n.openGate=_,qf(n)}}var ip=class{#e=0;#t;#n;#r;constructor(e,t,n){this.#t=e,this.#n=t,this.#r=n}tick(e){this.#e+=e,!(this.#e<Z.COMBAT_TICK_RATE)&&(this.#e-=Z.COMBAT_TICK_RATE,this.#i())}#i(){for(let e=0;e<this.#t.length;e++){let t=this.#t[e],n=this.#r[e];if(t.breached)continue;let r=t.engagedSquads.filter(e=>e.units.some(e=>e.alive&&e.attacking));if(r.length===0)continue;let i=0,a=!1;for(let e of r)for(let t of e.units){if(!t.alive||!t.attacking||t.unitType===`goblin`)continue;let e=Z.UNITS[t.unitType];i+=e.attack*e.attackSpeed*Z.COMBAT_TICK_RATE,t.unitType===`ogre`&&(a=!0)}if(n&&n.activateCombat(),i>0&&(t.hp=Math.max(0,t.hp-i),Lf.play(`melee`),t.hp===0)){t.breach();continue}let o=r.filter(e=>e.units.some(e=>e.alive&&e.attacking&&e.unitType===`goblin`));if(o.length>0&&n){let e=Z.UNITS.goblin,t=e.attack*e.attackSpeed*Z.COMBAT_TICK_RATE;for(let e of o)for(let r of e.units)if(!(!r.alive||!r.attacking||r.unitType!==`goblin`)){if(!r.defenderTarget||r.defenderTarget.hp<=0){let e=n.getAliveDefenders();e.length>0?r.defenderTarget=e[Math.floor(Math.random()*e.length)]:(r.defenderTarget=null,r.attacking=!1,r.pool.playIdle(r))}r.defenderTarget&&n.damageSpecific(r.defenderTarget,t)}}a&&Math.random()<.15&&Lf.play(`ogre`)}$.checkDefeat()}},ap=`⚔️`,op=class{#e=[];#t=0;#n=null;#r=null;#i=document.getElementById(`timer`);#a=document.getElementById(`year-display`);#o=document.getElementById(`objective-banner`);#s=document.getElementById(`announce-banner`);#c=document.getElementById(`squad-panel`);#l=document.getElementById(`order-menu`);#u=document.getElementById(`order-confirm`);#d=document.getElementById(`breach-counter`);#f=document.getElementById(`retreat-btn`);#p=document.getElementById(`retreat-counter`);#m=document.getElementById(`unit-count`);#h=null;#g=null;#_=[];constructor(e){this.#e=e,this.#v(),this.#b(),this.#S(),this.#x(),this.#p?.classList.add(`hidden`),this.#d?.classList.add(`hidden`)}#v(){this.#c.innerHTML=``;for(let e of this.#e){let t=document.createElement(`div`);t.className=`squad-card`,t.dataset.id=e.id,t.innerHTML=`
                <div class="squad-header">
                    <span class="squad-icon">${ap}</span>
                    <span class="squad-name">${e.label}</span>
                    <span class="squad-size">×${e.units.length}</span>
                </div>
                <div class="squad-status">Sitting... bored...</div>
            `,t.addEventListener(`click`,()=>{this.#n=e.id,$.selectSquad(e.id),this.#y(e.id)}),this.#c.appendChild(t)}}#y(e){for(let t of this.#c.querySelectorAll(`.squad-card`))t.classList.toggle(`selected`,t.dataset.id===e)}showOrderMenu(e){this.#l.classList.remove(`hidden`);let t=document.getElementById(`order-menu-title`);t&&(t.textContent=e.order===`engaged`?`Send where now?`:`Where smash?`)}hideOrderMenu(){this.#l.classList.add(`hidden`)}#b(){for(let e of document.querySelectorAll(`.order-btn`)){let t=()=>{if(!this.#n)return;let t=e.dataset.section;$.issueOrder(this.#n,t,!0),Lf.play(`march`),this.#l.classList.add(`hidden`),this.#C()};e.addEventListener(`click`,t),this.#_.push({btn:e,handler:t})}}#x(){this.#f&&(this.#g=()=>{Lf.play(`retreat`),$.soundRetreat(),this.#f.classList.add(`hidden`)},this.#f.addEventListener(`click`,this.#g))}destroy(){this.#g&&this.#f?.removeEventListener(`click`,this.#g);for(let{btn:e,handler:t}of this.#_)e.removeEventListener(`click`,t);this.#_=[]}showRetreatButton(){this.#f?.classList.remove(`hidden`)}hideRetreatButton(){this.#f?.classList.add(`hidden`)}updateRetreatCounter(e,t){this.#p&&(this.#p.classList.remove(`hidden`),this.#p.textContent=`Made it out: ${e} / ${t}`)}showRetreatScreen(e,t){let n=document.getElementById(`retreat-screen`);if(!n)return;let r=n.querySelector(`#retreat-detail`);r&&(r.textContent=`${e} of ${t} goblins made it back alive. Zoob... mostly impressed.`),n.style.display=`flex`}#S(){let e=document.getElementById(`sound-toggle`);e&&e.addEventListener(`click`,()=>{let t=Lf.toggle();e.textContent=t?`🔇`:`🔊`,e.classList.toggle(`muted`,t)})}#C(){this.#u.classList.remove(`hidden`),clearTimeout(this.#r),this.#r=setTimeout(()=>{this.#u.classList.add(`hidden`)},1500)}updateBreachCounter(e,t){this.#d.classList.remove(`hidden`),this.#d.textContent=`Through the hole: ${e} of ${t}! GO GO GO!`}setYear(e,t){this.#a&&(this.#a.textContent=`YEAR ${e} / ${t}`)}showYearSummary(e){let t=document.getElementById(`year-summary`);if(!t)return;let{year:n,retreatedByType:r,wallHpBefore:i,reinforcements:a,nextYear:o}=e;t.querySelector(`#summary-year`).textContent=n,t.querySelector(`#summary-survivors`).textContent=`${r.orc} orcs, ${r.goblin} goblins, ${r.ogre} ogres`;let s=i.map(e=>{let t=Math.floor((e.maxHp-e.hp)/e.maxHp*100),n=t>=80?` — Zoob very happy!`:t>=40?` — okay, okay.`:` — Zoob make face.`;return`Section ${e.id}: ${t}% smashed${n}`});t.querySelector(`#summary-wall`).textContent=s.join(` | `);let c=a.orc-r.orc,l=a.goblin-r.goblin,u=a.ogre-r.ogre,d=c+l+u,f=d>0?`Zoob send more!`:d<0?`Zoob send fewer. Zoob disappointed.`:`Zoob send same. Zoob shrug.`;t.querySelector(`#summary-reinforcements`).textContent=`+${c} orcs, +${l} goblins, +${u} ogres — ${f}`,t.querySelector(`#next-year-btn`).textContent=`Year ${o} — Smash Harder!`,t.style.display=`flex`}hideYearSummary(){let e=document.getElementById(`year-summary`);e&&(e.style.display=`none`)}showVictoryScreen(){let e=document.getElementById(`victory-screen`);e.querySelector(`p`).textContent=`Wall is DOWN! Army march through! Zoob do little happy dance! YOU NOT FAIL ZOOB!`,e.style.display=`flex`}showDefeatScreen(){sp(`#ff2200`,.4),document.getElementById(`defeat-screen`).style.display=`flex`}showCampaignDefeatScreen(e=`Army all dead. Zoob very sad. Also very hungry.`){sp(`#ff2200`,.4);let t=document.getElementById(`defeat-screen`);t.querySelector(`p`).textContent=e,t.style.display=`flex`}update(e){this.#t+=e;let t=Math.floor(this.#t/60),n=Math.floor(this.#t%60);this.#i.textContent=String(t).padStart(2,`0`)+`:`+String(n).padStart(2,`0`),this.#w(),this.#T()}#w(){for(let e of this.#e){let t=this.#c.querySelector(`[data-id="${e.id}"]`);if(!t)continue;let n=e.units.filter(e=>e.alive).length,r=t.querySelector(`.squad-size`),i=t.querySelector(`.squad-status`);r&&(r.textContent=`×${n}`),i&&(i.textContent=e.order===`marching`?`→ Running to ${e.targetSection}!`:e.order===`engaged`?`⚔ Smashing ${e.targetSection}!`:e.order===`through`&&$.breachBlocked?`⚔ Stupid knights! Kill!`:e.order===`through`?`→ THROUGH! GO GO GO!`:e.order===`retreating`?`↓ Running away (smart!)`:n===0?`All dead. Zoob weep.`:`Sitting... bored...`),n===0&&t.classList.add(`dead`)}}#T(){if(!this.#m)return;let e=$.squads.reduce((e,t)=>e+t.units.filter(e=>e.alive).length,0);this.#m.textContent=`ZOOB'S ARMY: ${e}`}updateObjectiveBanner(e){this.#o.textContent=e}announce(e,t=3500){this.#s&&(this.#s.textContent=e,this.#s.classList.remove(`hidden`),clearTimeout(this.#h),this.#h=setTimeout(()=>{this.#s?.classList.add(`hidden`)},t))}};function sp(e,t){let n=document.getElementById(`flash-overlay`);n.style.backgroundColor=e,n.style.opacity=`0.35`,setTimeout(()=>{n.style.opacity=`0`},t*1e3)}var cp=new It().setFromEuler(new mn(Math.PI/2,0,0)),lp=1.1,up=1.714,dp=lp/up*1.075,fp=new U,pp=class{#e=[];#t=0;#n=!1;#r;#i;#a;#o;#s;constructor(e,t,n,r){this.#r=t,this.#i=n,this.#a=r,this.#o=Z.SECTION_X[e.id],this.#s=Z.WALL_Z+id.FIRE_Z_OFF;for(let e=0;e<id.X_POSITIONS.length;e++){let t=id.MAGE_INDICES.has(e),n=this.#c(t,this.#o+id.X_POSITIONS[e]);n&&(this.#e.push(n),this.#t++)}}#c(e,t){let n=e?this.#a:this.#i;try{let r=this.#r.clone(n);Mf(r,id.HEIGHT);let i=r.position.y;r.position.set(t,id.WALL_TOP_Y+i,this.#s),r.rotation.y=0,r.traverse(t=>{if(t.isMesh&&(t.castShadow=!1,!e)){let e=e=>{let t=e.clone();return t.color.set(8951984),t.emissive&&t.emissive.set(1976888),t.metalness!==void 0&&(t.metalness=.85,t.roughness=.25),t};Array.isArray(t.material)?t.material=t.material.map(e):t.material=e(t.material)}}),hd.add(r);let a=this.#r.getAnimations(n),o=new ts(r);yd.add(o);let s=a.find(e=>e.name.toLowerCase().includes(`idle`))||a.find(e=>e.name.toLowerCase().includes(`stand`))||a.find(e=>!e.name.toLowerCase().includes(`attack`))||a[0],c=a.find(e=>e.name===`Idle_Hold`)||a.find(e=>e.name.toLowerCase().includes(`attack`))||s,l=s?o.clipAction(s).setLoop(L):null,u=c?o.clipAction(c).setLoop(L):null;this.#n&&u&&u!==l?u.reset().play():l&&l.play();let d=null,f=null;if(!e)try{d=this.#r.clone(X.BOW),d.scale.setScalar(lp/up),d.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.material=new Oa({color:9133628,roughness:.75,metalness:.05}))}),hd.add(d);for(let e of[`FistR`,`Fist.R`,`HandR`,`Hand.R`,`FistL`,`Fist.L`])if(r.traverse(t=>{t.name===e&&!f&&(f=t)}),f)break}catch{}return{model:r,mixer:o,hp:id.DEFENDER_HP,idleAction:l,attackAction:u,bowMesh:d,fistBone:f}}catch{return null}}update(){for(let e of this.#e)!e.bowMesh||!e.fistBone||(e.fistBone.getWorldPosition(fp),e.bowMesh.quaternion.copy(cp),e.bowMesh.position.copy(fp),e.bowMesh.position.z-=dp)}get aliveCount(){return this.#t}activateCombat(){if(!this.#n){this.#n=!0;for(let e of this.#e)e.hp<=0||!e.attackAction||e.attackAction===e.idleAction||(e.idleAction?.stop(),e.attackAction.reset().play())}}getAliveDefenders(){return this.#e.filter(e=>e.hp>0)}damageSpecific(e,t){e.hp<=0||(e.hp-=t,e.hp<=0&&(e.hp=0,this.#t--,yd.delete(e.mixer),hd.remove(e.model),e.bowMesh&&=(hd.remove(e.bowMesh),null)))}takeDamage(e){let t=this.getAliveDefenders();t.length!==0&&this.damageSpecific(t[Math.floor(Math.random()*t.length)],e)}spawnArcher(){if(this.#t>=md.DEFENDER_CAP)return;let e=(Math.random()*2-1)*8,t=this.#c(!1,this.#o+e);t&&(this.#e.push(t),this.#t++)}spawnReinforcements(e,t){for(let t=0;t<e&&!(this.#t>=md.DEFENDER_CAP);t++){let e=(Math.random()*2-1)*8,t=this.#c(!1,this.#o+e);t&&(this.#e.push(t),this.#t++)}for(let e=0;e<t&&!(this.#t>=md.DEFENDER_CAP);e++){let e=(Math.random()*2-1)*8,t=this.#c(!0,this.#o+e);t&&(this.#e.push(t),this.#t++)}}remove(){for(let e of this.#e)yd.delete(e.mixer),hd.remove(e.model),e.bowMesh&&hd.remove(e.bowMesh);this.#e=[],this.#t=0}rebuildForNewYear(){this.remove(),this.#n=!1;for(let e=0;e<id.X_POSITIONS.length;e++){let t=id.MAGE_INDICES.has(e),n=this.#c(t,this.#o+id.X_POSITIONS[e]);n&&(this.#e.push(n),this.#t++)}}},mp=[`autoL`,`autoC`,`autoR`,`resL`,`resC`,`resR`,`pool`],hp=[`autoL`,`autoC`,`autoR`],gp=[`autoL`,`autoC`,`autoR`,`resL`,`resC`,`resR`],_p=.02,vp=1.2,yp=class{onConfirm=null;#e;#t;#n;#r;#i;#a=new Map;#o=new Map;#s=new Map;#c=new Map;#l=null;#u=null;#d=null;#f=new Li(new U(0,1,0),0);#p=new rs;#m=new H;#h=new U;#g;#_;#v;#y;#b;#x;#S;#C;#w;#T=null;#E;constructor(e,t,n,r,i,a=ud){this.#e=e,this.#t=t,this.#n=n,this.#r=r,this.#i=i,this.#E=a;for(let e of mp)this.#a.set(e,new Set);this.#O(),this.#k(),this.#A(),this.#I(),this.#D()}#D(){let e=pd.SETUP_CAMERA_POS,t=pd.SETUP_CAMERA_TARGET;this.#t.position.set(e.x,e.y,e.z),this.#n.target.set(t.x,t.y,t.z),this.#n.update()}#O(){for(let[e,t]of Object.entries(pd.ZONES)){let n=t.isAuto?pd.PAD_COLORS.auto:e===`pool`?pd.PAD_COLORS.pool:pd.PAD_COLORS.reserve,r=new si(new ga(t.padW,t.padD),new Yr({color:n,transparent:!0,opacity:.35,depthWrite:!1,side:2}));r.rotation.x=-Math.PI/2,r.position.set(t.x,_p,t.z),r.userData.zoneId=e,this.#e.add(r),this.#s.set(e,r);let i=document.createElement(`div`);i.className=`zone-label`,i.textContent=t.label;let a=new Yu(i);a.position.set(t.x,.1,t.z-t.padD/2-.3),this.#e.add(a),this.#c.set(e,a)}}#k(){let e=pd.ZONES.pool,t=[];for(let[e,n]of Object.entries(this.#E))for(let r=0;r<n;r++)t.push(e);let n=Math.ceil(Math.sqrt(t.length));for(let r=0;r<t.length;r++){let i=t[r],a=this.#i[i],o=r%n,s=Math.floor(r/n),c=e.x+(o-(n-1)/2)*vp,l=e.z+(s-(Math.ceil(t.length/n)-1)/2)*vp,u=a.spawn(1,new U);u&&(u.unitType=i,u.pool=a,u.model.position.set(c,u.yOffset,l),a.playIdle(u),this.#a.get(`pool`).add(u),this.#o.set(u,`pool`))}}#A(){this.#x=document.getElementById(`setup-overlay`),this.#S=document.getElementById(`unassigned-num`),this.#C=document.getElementById(`start-battle-btn`),this.#w=document.getElementById(`setup-warning`),this.#x.style.display=`block`,this.#j(),this.#y=()=>this.#N(),this.#b=()=>this.#W(),document.getElementById(`assign-all-btn`).addEventListener(`click`,this.#y),this.#C.addEventListener(`click`,this.#b)}#j(){let e=this.#a.get(`pool`).size;this.#S.textContent=e,this.#C.disabled=e>0,this.#C.classList.toggle(`ready`,e===0)}#M(e){this.#w.textContent=e,this.#w.style.display=`block`,clearTimeout(this.#T),this.#T=setTimeout(()=>{this.#w.style.display=`none`},2200)}#N(){let e=[...this.#a.get(`pool`)];if(e.length===0)return;let t=e.filter(e=>e.unitType===`ogre`),n=e.filter(e=>e.unitType!==`ogre`);for(let e=0;e<t.length;e++){let n=hp[e%hp.length];this.#P(t[e],n)}for(let e=0;e<n.length;e++){let t=gp[e%gp.length];this.#P(n[e],t)}for(let e of mp)this.#F(e);this.#j()}#P(e,t){let n=this.#o.get(e);n!==t&&(this.#a.get(n)?.delete(e),this.#a.get(t).add(e),this.#o.set(e,t))}#F(e){let t=pd.ZONES[e],n=[...this.#a.get(e)];if(n.length===0)return;let r=Math.max(1,Math.ceil(Math.sqrt(n.length))),i=Math.ceil(n.length/r);for(let e=0;e<n.length;e++){let a=n[e];if(a===this.#l)continue;let o=e%r,s=Math.floor(e/r),c=t.x+(o-(r-1)/2)*vp,l=t.z+(s-(i-1)/2)*vp;a.model.position.set(c,a.yOffset,l)}}#I(){let e=this.#r.domElement;this.#g=e=>this.#z(e),this.#_=e=>this.#B(e),this.#v=e=>this.#V(e),e.addEventListener(`mousedown`,this.#g),e.addEventListener(`mousemove`,this.#_),e.addEventListener(`mouseup`,this.#v)}#L(){let e=this.#r.domElement;e.removeEventListener(`mousedown`,this.#g),e.removeEventListener(`mousemove`,this.#_),e.removeEventListener(`mouseup`,this.#v)}#R(e){let t=this.#r.domElement.getBoundingClientRect();this.#m.x=(e.clientX-t.left)/t.width*2-1,this.#m.y=-((e.clientY-t.top)/t.height)*2+1}#z(e){if(e.button!==0)return;this.#R(e),this.#p.setFromCamera(this.#m,this.#t);let t=[...this.#o.keys()],n=t.map(e=>e.model),r=this.#p.intersectObjects(n,!0);if(!r.length)return;let i=r[0].object,a=null;for(;i&&(a=t.find(e=>e.model===i),!a);)i=i.parent;a&&(e.stopPropagation(),this.#l=a,this.#u=this.#o.get(a),this.#n.enabled=!1,a.model.position.y=a.yOffset+pd.LIFT_Y)}#B(e){if(!this.#l)return;this.#R(e),this.#p.setFromCamera(this.#m,this.#t),this.#p.ray.intersectPlane(this.#f,this.#h),this.#h&&this.#l.model.position.set(this.#h.x,this.#l.yOffset+pd.LIFT_Y,this.#h.z);let t=[...this.#s.values()],n=this.#p.intersectObjects(t),r=this.#d;n.length?this.#d=n[0].object.userData.zoneId:this.#d=null,r!==this.#d&&(r&&this.#U(r),this.#d&&this.#H(this.#d))}#V(e){if(!this.#l)return;let t=this.#l,n=this.#u,r=this.#d;this.#l=null,this.#u=null,this.#d&&this.#U(this.#d),this.#d=null,this.#n.enabled=!0;let i=t.unitType===`ogre`&&r&&pd.ZONES[r]?.isReserve;if(!r||i){i&&this.#M(`Ogres cannot join Reserve squads!`),this.#P(t,n),this.#F(n),this.#j();return}this.#P(t,r),this.#F(n),this.#F(r),this.#j()}#H(e){let t=this.#s.get(e),n=this.#l;if(!t)return;let r=n?.unitType===`ogre`&&pd.ZONES[e]?.isReserve;t.material.color.setHex(r?pd.PAD_COLORS.invalid:pd.PAD_COLORS.hover),t.material.opacity=.55}#U(e){let t=this.#s.get(e),n=pd.ZONES[e];if(!t||!n)return;let r=n.isAuto?pd.PAD_COLORS.auto:e===`pool`?pd.PAD_COLORS.pool:pd.PAD_COLORS.reserve;t.material.color.setHex(r),t.material.opacity=.35}#W(){if(this.#a.get(`pool`).size>0)return;let e={autoL:document.getElementById(`target-autoL`).value,autoC:document.getElementById(`target-autoC`).value,autoR:document.getElementById(`target-autoR`).value},t={};for(let e of gp)t[e]=[...this.#a.get(e)];this.onConfirm&&this.onConfirm(t,e)}getZoneUnits(e){return[...this.#a.get(e)]}destroy(){this.#L(),document.getElementById(`assign-all-btn`)?.removeEventListener(`click`,this.#y),this.#C?.removeEventListener(`click`,this.#b);for(let e of this.#s.values())this.#e.remove(e),e.geometry.dispose(),e.material.dispose();for(let e of this.#c.values())this.#e.remove(e);this.#s.clear(),this.#c.clear(),this.#x.style.display=`none`}update(e){}},bp=new q(ld.SILVER),xp=class{model=null;hp=ld.HP;alive=!0;speed=ld.SPEED;attack=ld.ATTACK;attackSpeed=ld.ATTACK_SPEED;#e=null;#t=null;#n=[];#r=[];#i=[];constructor(e,t){let n=e.clone(X.KNIGHT_HORSE),r=e.clone(X.KNIGHT_RIDER);Mf(n,ld.HORSE_H),Mf(r,ld.RIDER_H);let i=ld.HORSE_H*ld.SADDLE_FRAC;r.position.y+=i,r.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.material=new Oa({color:bp,metalness:.6,roughness:.3,emissive:new q(0),emissiveIntensity:0}),this.#i.push(e))}),n.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material=e.material.clone(),e.material.emissive&&this.#i.push(e))}),this.model=new Mn,this.model.add(n),this.model.add(r),this.model.position.copy(t),hd.add(this.model),this.#n=e.getAnimations(X.KNIGHT_HORSE),this.#r=e.getAnimations(X.KNIGHT_RIDER),this.#e=new ts(n),this.#t=new ts(r),yd.add(this.#e),yd.add(this.#t),this.playIdle()}playIdle(){this.#a(this.#e,this.#n,!0,`idle`,`stand`),this.#a(this.#t,this.#r,!0,`idle`,`stand`)}playRun(){this.#a(this.#e,this.#n,!0,`run`,`walk`),this.#a(this.#t,this.#r,!0,`idle_attack`,`idle`,`stand`)}playAttack(){this.#a(this.#e,this.#n,!0,`idle`,`stand`),this.#a(this.#t,this.#r,!0,`attack`,`idle_attack`)}playDeath(){this.#a(this.#e,this.#n,!1,`death`,`die`),this.#a(this.#t,this.#r,!1,`death`,`die`)}die(){this.alive&&(this.alive=!1,this.playDeath(),setTimeout(()=>this.remove(),1500))}flashHit(){for(let e of this.#i)e.material.emissive.setHex(16720384),e.material.emissiveIntensity=.6;setTimeout(()=>{for(let e of this.#i)e.material.emissive.setHex(0),e.material.emissiveIntensity=0},200)}remove(){yd.delete(this.#e),yd.delete(this.#t),hd.remove(this.model)}#a(e,t,n,...r){let i=t.find(e=>r.some(t=>e.name.toLowerCase().includes(t)));if(!i)return;let a=e.clipAction(i);a.reset(),a.setLoop(n?L:Pe),a.clampWhenFinished=!n,a.play()}},Sp=1.8,Cp=1,wp=.25,Tp=[-3,0,3],Ep=[-15,-5,5,15],Dp=8,Op=2,kp=1,Ap=class{#e;#t=[];#n=!1;#r=!1;#i=0;constructor(e){this.#e=e}get allKnightsDead(){return this.#n&&this.#t.every(e=>!e.knight.alive)}deploy(){if(!this.#n){this.#n=!0,$.state===Rf.BREACH&&($.breachBlocked=!0,this.#r=!0);for(let e of Tp)this.#a(e);setTimeout(()=>{for(let e of Tp)this.#a(e)},wp*1e3)}}deploySortie(e=12){let t=Math.ceil(e/Ep.length);for(let n=0;n<t;n++){let t=n*Ep.length,r=Math.min(Ep.length,e-t);setTimeout(()=>{for(let e=0;e<r;e++)this.#a(Ep[e])},n*wp*1e3)}}#a(e){let t=new U(e,0,Z.WALL_Z+1),n=new xp(this.#e,t);n.model.rotation.y=0,n.playRun(),this.#t.push({knight:n,attackTimer:0,target:null})}#o(e){let t=[];for(let n of $.squads)for(let r of n.units){if(!r.alive)continue;let n=r.model.position.x-e.position.x,i=r.model.position.z-e.position.z;t.push({unit:r,d2:n*n+i*i})}if(t.length===0)return null;t.sort((e,t)=>e.d2-t.d2);let n=t.slice(0,4);return n[Math.floor(Math.random()*n.length)].unit}#s(e){let t=null,n=1/0;for(let r of this.#t){if(!r.knight.alive)continue;let i=r.knight.model.position.x-e.x,a=r.knight.model.position.z-e.z,o=i*i+a*a;o<n&&(n=o,t=r)}return t}#c(){this.#r=!1,$.breachBlocked=!1;for(let e of $.squads)if(e.order===`through`)for(let t of e.units)t.alive&&t.pool.playWalk(t)}#l(e){if(this.#t.filter(e=>e.knight.alive).length===0){this.#c();return}this.#i+=e;let t=this.#i>=kp;t&&(this.#i=0);for(let n of $.squads)if(n.order===`through`)for(let r of n.units){if(!r.alive)continue;let n=this.#s(r.model.position);if(!n)continue;let i=n.knight.model.position,a=i.x-r.model.position.x,o=i.z-r.model.position.z,s=Math.sqrt(a*a+o*o);if(r.model.rotation.y=Math.atan2(a,o),s>Op){let t=Z.UNITS[r.unitType].speed;r.model.position.x+=a/s*t*e,r.model.position.z+=o/s*t*e}if(t&&s<=Op){let e=Z.UNITS[r.unitType];n.knight.hp-=e.attack*e.attackSpeed,n.knight.flashHit(),n.knight.hp<=0&&n.knight.die()}}}#u(e){if(this.#t.filter(e=>e.knight.alive).length===0)return;this.#i+=e;let t=this.#i>=kp;t&&(this.#i=0);for(let e of $.squads)for(let n of e.units){if(!n.alive)continue;let e=this.#s(n.model.position);if(!e)continue;let r=e.knight.model.position.x-n.model.position.x,i=e.knight.model.position.z-n.model.position.z,a=Math.sqrt(r*r+i*i);if(a<=Dp&&(n.model.rotation.y=Math.atan2(r,i)),!t||a>(n.unitType===`goblin`?Z.GOBLIN_RANGE:Op))continue;let o=Z.UNITS[n.unitType];e.knight.hp-=o.attack*o.attackSpeed,e.knight.flashHit(),e.knight.hp<=0&&e.knight.die()}}reset(){for(let e of this.#t)e.knight.remove();this.#t=[],this.#n=!1,this.#r=!1,this.#i=0,$.breachBlocked=!1}update(e){this.#r?this.#l(e):$.state===Rf.PLAYING&&this.#u(e);for(let t of this.#t){if(!t.knight.alive)continue;(!t.target||!t.target.alive||t.target.model.position.z>=Z.RETREAT_Z)&&(t.target=this.#o(t.knight.model),t.attackTimer=0);let n=t.target;if(!n){t.knight.playIdle();continue}let r=n.model.position.x-t.knight.model.position.x,i=n.model.position.z-t.knight.model.position.z,a=Math.sqrt(r*r+i*i);t.knight.model.rotation.y=Math.atan2(r,i),a>.4&&(t.knight.model.position.x+=r/a*ld.SPEED*e,t.knight.model.position.z+=i/a*ld.SPEED*e),a<=Sp?(t.attackTimer+=e,t.attackTimer>=Cp&&(t.attackTimer=0,n.alive&&(n.hp-=ld.ATTACK,n.pool.flashHit(n),n.hp<=0&&n.squad.killUnit(n)))):t.attackTimer=0}}},jp=class{onAnnounce=null;#e;#t;#n=!1;#r=0;#i=0;#a=0;#o=0;#s=0;#c=!1;#l=!1;#u=!1;#d=!0;constructor(e,t){this.#e=e,this.#t=t}get active(){return this.#n}start(){if(this.#n)return;this.#n=!0;let e=(e,t)=>e+Math.random()*(t-e);this.#a=e(md.EVENT1_MIN,md.EVENT1_MAX),this.#o=e(md.EVENT2_MIN,md.EVENT2_MAX),this.#s=e(md.EVENT3_MIN,md.EVENT3_MAX),this.#d=Math.random()<.5}stop(){this.#n=!1}reset(){this.#n=!1,this.#r=0,this.#i=0,this.#c=!1,this.#l=!1,this.#u=!1}update(e){this.#n&&(this.#r+=e,this.#i+=e,this.#i>=md.TRICKLE_INTERVAL&&(this.#i-=md.TRICKLE_INTERVAL,this.#f()),!this.#c&&this.#r>=this.#a&&(this.#c=!0,this.#p(this.#d?`R1`:`R2`)),!this.#l&&this.#r>=this.#o&&(this.#l=!0,this.#p(this.#d?`R2`:`R1`)),!this.#u&&this.#r>=this.#s&&(this.#u=!0,this.#p(`R1`)))}#f(){let e=1/0,t=0;for(let n=0;n<this.#e.length;n++)this.#e[n].aliveCount<e&&(e=this.#e[n].aliveCount,t=n);this.#e[t].spawnArcher()}#p(e){if(e===`R1`){for(let e of this.#e)e.spawnReinforcements(md.R1_ARCHERS,md.R1_MAGES);this.onAnnounce?.(`More defenders come! This very bad for us!`)}else this.#t.deploySortie(md.SORTIE_COUNT),this.onAnnounce?.(`KNIGHTS COME OUT! Kill them! Kill them!`)}},Mp=Object.values(X),Np=document.getElementById(`loading-screen`),Pp=document.getElementById(`progress-bar`),Fp=document.getElementById(`loading-status`);async function Ip(e){let t=0,n=Mp.length,r=Mp.map(r=>{let i=!1;return e.load(r).catch(e=>{console.warn(`Failed to load ${r}:`,e),i=!0}).finally(()=>{t++,Pp.style.width=t/n*100+`%`,Fp.textContent=i?`Warning: could not load ${r.split(`/`).pop()}`:`Loading assets… (${t}/${n})`})});await Promise.all(r)}function Lp(e,t,n,r,i,a,o=0,s=null){try{let c=e.clone(t);s?(Mf(c,s),c.position.set(n,c.position.y,i)):(c.position.set(n,r,i),c.scale.setScalar(a)),c.rotation.y=o,c.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)}),hd.add(c)}catch{}}function Rp(e){let t=[],n=[{xBase:-26,zList:[22,8,-5,-18,-32,-45],scale:3.8,path:X.MOUNTAIN_LG},{xBase:-38,zList:[16,1,-12,-25,-39],scale:4.2,path:X.MOUNTAIN_GRP},{xBase:-50,zList:[10,-5,-20,-35],scale:3.5,path:X.MOUNTAIN_GRP2},{xBase:26,zList:[22,8,-5,-18,-32,-45],scale:3.8,path:X.MOUNTAIN_GRP},{xBase:38,zList:[16,1,-12,-25,-39],scale:4.2,path:X.MOUNTAIN_LG},{xBase:50,zList:[10,-5,-20,-35],scale:3.5,path:X.MOUNTAIN_GRP2}];for(let{xBase:t,zList:r,scale:i,path:a}of n)for(let n of r)Lp(e,a,t+(Math.random()-.5)*4,0,n,i+Math.random()*.5,Math.random()*Math.PI*2);for(let[n,r]of[[-22,-8],[-24,-20],[-20,2],[22,-8],[24,-20],[20,2]])Lp(e,X.PINE_GRP,n,0,r,1.6+Math.random()*.4,Math.random()*Math.PI*2),t.push({x:n,z:r,radius:3});for(let[n,r]of[[-14,12],[-18,17],[-10,20],[14,12],[18,17],[10,20]])Lp(e,X.TREE1,n,0,r,1,Math.random()*Math.PI*2,3),t.push({x:n,z:r,radius:.9});for(let[n,r]of[[-8,-5],[6,-8],[-3,-15],[10,-3],[-12,-20]])Lp(e,X.ROCK,n,0,r,1,Math.random()*Math.PI*2,.8+Math.random()*.6),t.push({x:n,z:r,radius:1.2});return t}var zp=[],Bp=new ha(ad.ARROW_RADIUS,ad.ARROW_RADIUS,ad.ARROW_LENGTH,4);Bp.rotateX(Math.PI/2);var Vp=new Yr({color:ad.ARROW_COLOR}),Hp=new _a(ad.BOLT_RADIUS,6,5),Up=new Yr({color:ad.BOLT_COLOR}),Wp=new ha(.03,.015,.55,4);Wp.rotateX(Math.PI/2);var Gp=new Yr({color:9136404}),Kp={arrow:[],bolt:[],spear:[]};{let e=[{key:`arrow`,geo:Bp,mat:Vp,size:20},{key:`bolt`,geo:Hp,mat:Up,size:20},{key:`spear`,geo:Wp,mat:Gp,size:40}];for(let{key:t,geo:n,mat:r,size:i}of e)for(let e=0;e<i;e++){let e=new si(n,r);e.visible=!1,hd.add(e),Kp[t].push({mesh:e,type:t,from:new U,to:new U,t:0,dur:0})}}function qp(e,t,n=`arrow`){let r=Kp[n].pop();r&&(r.from.copy(e),r.to.copy(t),r.t=0,r.dur=n===`spear`?ad.SPEAR_DURATION:n===`bolt`?ad.BOLT_DURATION:ad.ARROW_DURATION,r.mesh.position.copy(e),n!==`bolt`&&r.mesh.lookAt(t),r.mesh.visible=!0,zp.push(r),n===`arrow`?Lf.play(`arrow`):n===`bolt`?Lf.play(`mage`):n===`spear`&&Lf.play(`spear`))}function Jp(e){for(let t=zp.length-1;t>=0;t--){let n=zp[t];n.t+=e/n.dur,n.t>=1?(n.mesh.visible=!1,Kp[n.type].push(n),zp.splice(t,1)):(n.mesh.position.lerpVectors(n.from,n.to,n.t),n.mesh.position.y+=Math.sin(n.t*Math.PI)*ad.ARC_HEIGHT)}}var Yp=0;function Xp(e,t,n){if(Yp+=e,Yp<ad.TICK_INTERVAL)return;Yp=0;let r=$.squads;for(let e=0;e<t.length;e++){let i=t[e],a=n[e];if(i.breached)continue;let o=i.engagedSquads.filter(e=>e.units.some(e=>e.alive));if(o.length===0)continue;Z.SECTION_X[i.id];let s=a?a.aliveCount/id.X_POSITIONS.length:1,c=Math.max(0,Math.round(ad.VOLLEY_COUNT*s)),l=[];for(let e of o)for(let t of e.units)t.alive&&l.push(t);let u=[...l],d=[...l];for(let e of r)if(!(e.order!==`marching`||e.targetSection!==i.id))for(let t of e.units){if(!t.alive)continue;let e=t.model.position.z-Z.WALL_Z;e<=ad.ARCHER_RANGE&&u.push(t),e<=ad.MAGE_RANGE&&d.push(t)}let f=a?a.getAliveDefenders():[];for(let e=0;e<c;e++){let e=Math.random()<ad.MAGIC_CHANCE,t=e?d:u;if(t.length===0||f.length===0)continue;let n=f[Math.floor(Math.random()*f.length)].model.position.clone();n.y+=id.HEIGHT*.65;let r=t[Math.floor(Math.random()*t.length)];if(!r.alive)continue;qp(n,r.model.position.clone().add(new U(0,ad.TARGET_Y_OFFSET,0)),e?`bolt`:`arrow`);let i=e?id.MAGE_ATTACK:id.ARCHER_ATTACK;r.hp-=i,r.pool.flashHit(r),r.hp<=0&&r.squad.killUnit(r)}for(let e of o)for(let t of e.units)!t.alive||!t.attacking||t.unitType!==`goblin`||!t.defenderTarget||t.defenderTarget.hp<=0||qp(t.model.position.clone().add(new U(0,cd.goblin*.7,0)),t.defenderTarget.model.position.clone().add(new U(0,.3,0)),`spear`)}}var Zp=[`autoL`,`autoC`,`autoR`,`resL`,`resC`,`resR`];function Qp(e,t,n){let r=[];for(let i of Zp){let a=pd.ZONES[i],o=e[i]??[],s=new U(a.x,0,a.z),c=Kf.fromUnits(i,a.label,o,s);c.isAuto=a.isAuto,c.isReserve=a.isReserve,c.setWallSections(t),c.setAllSquads(r),c.setObstacles(n),r.push(c)}return r}var $p=null;async function em(){let e=new jf;await Promise.all([Ip(e),Lf.load()]),Np.style.display=`none`,await new Promise(e=>{let t=document.getElementById(`intro-screen`);t.style.display=`flex`,document.getElementById(`intro-continue-btn`).addEventListener(`click`,()=>{t.style.display=`none`,e()},{once:!0})});let t=new Ap(e);$.knightSystem=t;let n=Rp(e),r=[new np(`A`),new np(`B`),new np(`C`)];rp(e,r);let i={orc:{path:X.ORC,height:cd.orc},goblin:{path:X.GOBLIN,height:cd.goblin},ogre:{path:X.OGRE,height:cd.ogre}},a={};for(let[t,n]of Object.entries(dd)){let{path:r,height:o}=i[t];a[t]=new Vf(e,r,n,hd,o)}let o=r.map(t=>new pp(t,e,X.ARCHER,X.MAGE));for(let e=0;e<r.length;e++){let t=o[e];r[e].onBreach=()=>{t.remove(),Lf.play(`breach`)}}let s=new jp(o,t);s.onAnnounce=e=>$.ui?.announce(e),$.defenseReinforcements=s;let c=new Iu(gd,_d.domElement);c.target.set(Z.CAMERA_TARGET.x,Z.CAMERA_TARGET.y,Z.CAMERA_TARGET.z),c.minDistance=Z.CAMERA_MIN_DIST,c.maxDistance=Z.CAMERA_MAX_DIST,c.maxPolarAngle=Math.PI/2.1,c.enableDamping=!0,c.dampingFactor=.08,c.enablePan=!0,c.update();let l=new Nf;$.wallSections=r;let u=null,d=null;function f(e){$.ui?.destroy(),document.getElementById(`retreat-counter`)?.classList.add(`hidden`),document.getElementById(`breach-counter`)?.classList.add(`hidden`),$.state=Rf.SETUP,$.squads=[],$.ui=null,$.unitsThroughBreach=0,$.retreatedUnits=0,$.retreatedByType={orc:0,goblin:0,ogre:0},$.breachBlocked=!1,$.onRetreatComplete=null,u=null,t.reset(),s.reset();let i=l.computeWallRepairs(r);for(let{id:e,newHp:t}of i)r.find(t=>t.id===e).reset(t);for(let e of r)Jf(e),e.labelDirty=!1;for(let e of o)e.rebuildForNewYear();document.getElementById(`year-display`).textContent=`YEAR ${l.year} / ${l.maxYears}`,document.getElementById(`objective-banner`).textContent=`Pick squads! Drag goblins to squads! Then click SMASH WALL NOW!`,d=new yp(hd,gd,c,_d,a,e),d.onConfirm=(e,t)=>{d.destroy(),d=null;let i=Qp(e,r,n);u=new ip(r,i,o);let a=new op(i.filter(e=>!e.isAuto));a.setYear(l.year,l.maxYears),$.squads=i,$.ui=a,$.onRetreatComplete=(e,t)=>{let n=r.map(e=>({id:e.id,hp:e.hp,maxHp:e.maxHp})),i=l.computeReinforcements(t,r);if(l.year>=l.maxYears){a.showCampaignDefeatScreen(`Ten years gone. Wall still stand. Zoob go cry in corner. Also you fired.`);return}let o=l.year+1;a.showYearSummary({year:l.year,retreatedByType:t,wallHpBefore:n,reinforcements:i,nextYear:o}),document.getElementById(`next-year-btn`).onclick=()=>{a.hideYearSummary(),l.advance(i),f(l.startingUnits)}},$p={fromPos:gd.position.clone(),fromTarget:c.target.clone(),toPos:new U(Z.CAMERA_POS.x,Z.CAMERA_POS.y,Z.CAMERA_POS.z),toTarget:new U(Z.CAMERA_TARGET.x,Z.CAMERA_TARGET.y,Z.CAMERA_TARGET.z),t:0,dur:1.2},$.startBattle(t)}}$.state=Rf.SETUP,document.getElementById(`year-display`).textContent=`YEAR ${l.year} / ${l.maxYears}`,document.getElementById(`objective-banner`).textContent=`Pick squads! Drag goblins to squads! Then click SMASH WALL NOW!`,d=new yp(hd,gd,c,_d,a,l.startingUnits),d.onConfirm=(e,t)=>{d.destroy(),d=null;let i=Qp(e,r,n);u=new ip(r,i,o);let a=new op(i.filter(e=>!e.isAuto));a.setYear(l.year,l.maxYears),$.squads=i,$.ui=a,$.onRetreatComplete=(e,t)=>{let n=r.map(e=>({id:e.id,hp:e.hp,maxHp:e.maxHp})),i=l.computeReinforcements(t,r);if(l.year>=l.maxYears){a.showCampaignDefeatScreen(`Ten years gone. Wall still stand. Zoob go cry in corner. Also you fired.`);return}let o=l.year+1;a.showYearSummary({year:l.year,retreatedByType:t,wallHpBefore:n,reinforcements:i,nextYear:o}),document.getElementById(`next-year-btn`).onclick=()=>{a.hideYearSummary(),l.advance(i),f(l.startingUnits)}},$p={fromPos:gd.position.clone(),fromTarget:c.target.clone(),toPos:new U(Z.CAMERA_POS.x,Z.CAMERA_POS.y,Z.CAMERA_POS.z),toTarget:new U(Z.CAMERA_TARGET.x,Z.CAMERA_TARGET.y,Z.CAMERA_TARGET.z),t:0,dur:1.2},$.startBattle(t)};let p=new Ro;_d.setAnimationLoop(()=>{p.update();let e=Math.min(p.getDelta(),.1);if($.state===Rf.SETUP&&d?.update(e),$.state===Rf.PLAYING||$.state===Rf.BREACH||$.state===Rf.RETREAT){for(let t of $.squads)t.update(e);u?.tick(e);for(let e of r)e.labelDirty&&=(Jf(e),!1);$.ui?.update(e),Xp(e,r,o),t.update(e),$.state===Rf.PLAYING&&!s.active&&r.some(e=>e.engagedSquads.length>0)&&s.start(),s.update(e)}$p&&($p.t+=e/$p.dur,$p.t>=1?($p.t=1,gd.position.copy($p.toPos),c.target.copy($p.toTarget),$p=null):(gd.position.lerpVectors($p.fromPos,$p.toPos,$p.t),c.target.lerpVectors($p.fromTarget,$p.toTarget,$p.t))),Jp(e);for(let e of o)e.update();c.update();for(let t of yd)t.update(e);_d.render(hd,gd),vd.render(hd,gd)})}document.getElementById(`title-screen`).addEventListener(`click`,()=>{document.getElementById(`title-screen`).style.display=`none`,em().catch(e=>{console.error(`Init failed:`,e),document.getElementById(`loading-status`).textContent=`Failed to load. Check console.`})},{once:!0});